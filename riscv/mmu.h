...
public:
  ...
  inline icache_entry_t* refill_icache(reg_t addr, icache_entry_t* entry)
  {
      ...
      insn_fetch_t fetch = {proc->decode_insn(ILAsimInst), ILAsimInst};
      entry->tag = addr;
      entry->data = fetch;
	  return entry;
  	}
  ...
  void setILAsimMode(insn_bits_t inst, bool fetchPTBcheck)
  	{
  		ILAsimInst = inst; ILAsimMode = true; ILAFetchPTBCheck = fetchPTBcheck;
  	}
  
private:
  insn_bits_t ILAsimInst;
  bool ILAsimMode;
  bool ILAFetchPTBCheck;
